...
def build_model(images, num_classes, is_training=True):
    ...
    logits, attention, feature_map = model.AttentionModel(images, num_classes=num_classes, training_resnet=False,
...
def main(unused_argv):
    ...
    train_filenames, train_labels = list_images(cmd_args.train_data)
    val_filenames, val_labels = list_images(cmd_args.val_data)
    ...
    with tf.Session() as sess:
        sess.run(init_op)
        saver.restore(sess, "my_weights/something")
        ...
        for epoch in range(epochs):
            ...
            for batch in range(num_batches):
                ...
                if batch % 100 == 0:
                    ...
                    accumated_acc = sum(acc_at_each_epoch) / len(acc_at_each_epoch)
            ...
            print("validation acc is: " + str(val_acc))
            saver2.save(sess, "my_weights/trained_model")
